...
<div class="ml-4 mt-5"> <h1 class="text-lg font-semibold">Product List</h1> <div> <p class="text-sm text-gray-500">Home
    > Product List</p>
    </div> <div class="w-full h-[75vh] flex justify-start items-center over-flow-y-auto mt-10">
    <div class="w-[95%] h-full bg-gray-100 rounded"> <div
        ...
        <select name="" id="" class="bg-gray-100 rounded border border-blue-500 p-1 outline-none">
          ...
          <table class="w-full border-separate border-spacing-x-2 border-spacing-y-3 mt-2">
                ...
                <th class="text-sm text-gray-500 bg-green-600 text-start">Name</th>
                ...
                <tbody class="text-center text-sm">
                    ...
                    <tr class="">
                        ...
                        <td class="text-justify bg-green-500">{{$product->perfume_name}}</td>
