            ...
            <div
                ...
                <div class="pl-10 pr-4 mt-4">
                    ...
                    <div class="flex flex-wrap justify-between">
                        <div
                            class="w-40 h-40 bg-blue-500 rounded-md group hover:bg-gray-900 flex flex-col justify-center items-center space-y-3 mb-16">
                            ...
                            <span class="text-sm text-white group-hover:text-gray-600">Admin</span>
                        </div>
                        ...
                        <div
                            class="w-40 h-40 bg-gray-300 group hover:bg-gray-900 flex flex-col justify-center items-center space-y-3 ">
                            <div class="flex justify-center items-center flex-col">
                                <div class="w-12 h-12 bg-gray-600 rounded-full mb-2">
                                    <img src="" alt="">
                                </div>
                            ...
                            <span class="text-sm text-white group-hover:text-gray-600">Editor</span>
                        </div>
