            ...
            <div
                ...
                <div class="pl-10 pr-4 mt-4">
                    ...
                    <div class="flex flex-wrap justify-between">
                        <div
                            class="w-40 h-40 bg-blue-500 rounded-md group flex flex-col justify-center items-center space-y-3 mb-16">
                        ...
                        <div
                            class="w-40 h-40 bg-gray-300 rounded-md group hover:bg-blue-500 flex flex-col justify-center items-center space-y-3 mb-16">
                            <div class="flex justify-center items-center flex-col">
                                <div class="w-12 h-12 bg-gray-600 rounded-full mb-2">
                                    <img src="" alt="">
                                </div>
                        ...
                        <div
                            ...
                            <div class="flex justify-center items-center flex-col">
                                <div
                                    class="w-12 h-12  group-hover:bg-gray-800 flex justify-center items-center flex-col rounded-full  bg-100 mb-2">
                                    <div
