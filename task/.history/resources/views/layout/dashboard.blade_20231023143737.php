...
<body class="overflow-x-hidden">
    <section>
        <nav class="w-screen bg-white">
            <div class=" flex justify-end items-center relative p-2">
                <div
                    class="lg:w-[20%] md:w-[30%] sm:w-[40%]  md:block  bg-gray-800 flex justify-center items-center absolute md:left-0 top-0 sm:-left-[100%]  z-10  navsidebar-toggle">
                    <!-- side bar  -->



                    <div
                        class="w-full  flex justify-center items-center border-r border-r-gray-700 border-b border-b-gray-700 py-3">
                        <!-- brand  -->
        ...
        <!-- notification modal  -->
        <div class="" hidden>
            <div class="w-64 bg-gray-800 border rounded shadow-lg absolute right-5 md:right-52 top-20 z-20 mt-1 modal">
                <div class="text-gray-200 flex justify-center items-center flex-col pb-3">
                    <div class="w-full flex justify-center items-center border-b border-b-gray-100">
                        <div class="p-3">
        ...
        <!-- useraccount modal  -->
        <div class="" hidden>
            <div class="w-52 bg-gray-800 border rounded shadow-lg absolute right-5 md:right-12 top-20 z-20 mt-1 modal">
                <div class="text-gray-200 flex justify-center items-center flex-col pb-3">
                    <div class="w-full flex justify-center items-center border-b border-b-gray-100">
                        <div class="p-3">
                    ...
                    <div class="flex justify-center items-center self-start p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6 ">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a href="" class="ml-2">My Account</a>
                    </div>
                    ...
                    <div class="flex justify-center items-center self-start p-3">
                        ...
                        <a href="" class="ml-1">Email</a>
                    </div>

                    <div class="flex justify-center items-center self-start p-3 pb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a href="" class="ml-2">Log Out</a>
                    </div>



                    <div id="" class="flex justify-center items-center self-start p-3 pb-4 setting-btn">
                        ...
                        <button class="ml-2">Setting</button>
                    </div>
        ...
        <div>
            <div class="modal flex justify-center items-center  ">
                ...
                <div
                    class="w-full h-[100vh] bg-[linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5))] fixed left-0 top-0 z-10 modal-dialog none">
                </div>

                <div
                    class="w-[450px] h-[100vh] bg-gray-800  transition-all duration-200 absolute z-10 -right-[100%] top-0 modal-body">

                    <div class="w-full flex items-center border-b border-b-gray-700   pl-10 pr-4  py-5 ">
                        <div class="w-full text-white flex justify-between items-center">
                            <h3 class="text-xl text-blue-600">Settings</h3>
                            <div
                                class="w-12 h-12 flex justify-center items-center flex-col rounded-full hover:border-2 hover:border-gray-900 setting-x">
                                <div class="w-8 h-2 border-2 border-gray-500 transform rotate-45 translate-y-1"></div>
                                <div class="w-8 h-2 border-2 border-gray-500 transform -rotate-45 -translate-y-1"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class=" pl-10 pr-4  py-5">
                            <ul>
                                <li class="text-white flex justify-between items-center mb-4">
                                    ...
                                    <label for="toggle-switch" class="flex items-center cursor-pointer">
                                        ...
                                        <div class="relative w-10 h-5 bg-gray-700 rounded-lg">
                                            <div
                    ...
                    <div class="pl-10 pr-4 mt-4">
                        ...
                        <div class="flex flex-wrap justify-between">
                            <div
                                class="w-40 h-40 bg-slate-700 group hover:bg-gray-900 flex flex-col justify-center items-center space-y-3 mb-16">
                                <div class="flex justify-center items-center flex-col">
                                    <div class="w-12 h-12 bg-gray-600 rounded-full mb-2">
                                        <img src="" alt="">
                                    </div>

                                    <span class="text-white">John Luwis</span>
                                </div>
                                <span class="text-sm text-slate-500 group-hover:text-gray-600">Admin</span>
                            </div>
                            ...
                            <div
                                ...
                                <span class="text-sm text-slate-500 group-hover:text-gray-600">Editor</span>
                            </div>

                            <div
                                class="w-40 h-40 bg-slate-700 group hover:bg-gray-900 flex flex-col justify-center items-center space-y-3 ">
                                <div class="flex justify-center items-center flex-col">
                                    <div class="w-12 h-12 bg-gray-600 rounded-full mb-2">
                                        <img src="" alt="">
                                    </div>
                            ...
                            <div
                                ...
                                <div class="flex justify-center items-center flex-col">
                                    <div
                                        class="w-12 h-12 bg-gray-600 group-hover:bg-gray-800 flex justify-center items-center flex-col rounded-full  bg-100 mb-2">
                                        <div
            ...
            <div class="">
                <nav class="w-screen ">
                    ...
                    <div class=" flex justify-end items-center relative  ">
                        <div
                            class="lg:w-[20%] md:w-[30%] sm:w-[40%]  md:block  bg-white flex justify-center items-center absolute md:left-0 top-0 sm:-left-[100%] z-10  navsidebar-toggle">



                            <!-- side bar  -->
                            <div
                                class="w-full min-h-[101vh] flex justify-start items-start  border-t border-t-gray-600 ">
                                <!-- brand  -->
                        ...
                        <div class="lg:w-[80%] md:w-[70%] sm:w-full navbarwidth">
                            ...
                            <!-- footer  -->
                            <footer class="w-full bg-gray-800 text-black text-center p-3 mt-9">
