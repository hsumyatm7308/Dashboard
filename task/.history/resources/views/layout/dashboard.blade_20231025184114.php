        ...
        <div class="" hidden>
            <div class="w-52 bg-gray-100 border rounded shadow-lg absolute right-5 md:right-12 top-20 z-20 mt-1 modal">
                <div class=" flex justify-center items-center flex-col px-1 pb-3">
                    ...
                    <div class="text-gray-700 flex justify-center items-center self-start group hover:text-blue-500 px-3 pb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6 ">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div id="" class="text-gray-700 flex justify-center items-center self-start group hover:text-blue-500 px-3 pb-4 setting-btn">
                        ...
                        <ul>
                            <li class=" flex justify-between items-center mb-4">
                                ...
                                <label for="toggle-switch" class="flex items-center cursor-pointer">
                                    ...
                                    <div class="relative w-10 h-6 bg-blue-700 rounded-xl flex items-center">
                                        <div
                                            class="absolute left-0 w-5 h-5 rounded-full bg-gray-100 drop-shadow-lg transform translate-x-0 transition-transform slide mx-0.5">
                                        </div>
                                    </div>
                                </label>
                            </li>
                            ...
                            <li class=" flex justify-between items-center mb-4">
                                ...
                                <label for="toggle-switch3" class="flex items-center cursor-pointer">
                                    ...
                                    <div class="relative w-10 h-6 bg-blue-700 rounded-xl flex justify-start items-center">
                                        <div
                                            class="absolute left-0 w-5 h-5 rounded-full bg-gray-100 drop-shadow-lg transform translate-x-0 transition-transform slide mx-0.5">
                                        </div>
                                    </div>
                                ...
                                <div class="w-full text-black ">
                                    <div class="w-full list-none space-y-3 text-md capitalize mt-5">
                                        ...
                                        <li class="w-full pl-2  flex  items-center group py-2 ">
                                            <div class="px-3 ">
                                                <a href="{{route('dashboard/product-list')}}" class="flex justify-start items-center group hover:text-blue-500">
                                                    ...
                                                    <span class="ml-4 group-hover:text-blue-500"> Product List </span>
                                                </a>
                                            </div>
                                        </li>
                                        ...
                                        <li class="w-full pl-2 flex  items-center group py-2">
                                            <div class="px-3">
                                                <a href="{{route('productdetail')}}" class="flex justify-start items-center group hover:text-blue-500">
                                                    ...
                                                    <span class="ml-4 group-hover:text-blue-500"> Product Details
                                                    </span>
                                                </a>
                                            </div>
                                        </li>
                                        ...
                                        <li class="w-full pl-2   flex  items-center group py-2">
                                            <div class="px-3">
                                                <a href="#" class="flex justify-start items-center group hover:text-blue-500">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="w-6 h-6 text-gray-500 group-hover:text-blue-500">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <span class="ml-4 group-hover:text-blue-500"> Order List </span>
                                                </a>
                                            </div>
                                        </li>
                                        ...
                                        <li class="w-full pl-2   flex  items-center group py-2">
                                            <div class="px-3">
                                                <a href="#" class="flex justify-start items-center group hover:text-blue-500">
                                                    ...
                                                    <span class="ml-4 group-hover:text-blue-500"> Order Details </span>
                                                </a>
                                            </div>
                                        </li>
