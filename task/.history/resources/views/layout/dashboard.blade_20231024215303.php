                        ...
                        <ul>
                            <li class=" flex justify-between items-center mb-4">
                                ...
                                <label for="toggle-switch" class="flex items-center cursor-pointer">
                                    ...
                                    <div class="relative w-10 h-6 bg-blue-700 rounded-lg flex items-center">
                                        <div
                            ...
                            <li class=" flex justify-between items-center mb-4">
                                ...
                                <label for="toggle-switch3" class="flex items-center cursor-pointer">
                                    ...
                                    <div class="relative w-10 h-6 bg-blue-700 rounded-lg flex justify-start items-center">
                                        <div
                                            class="absolute left-0 w-5 h-5 rounded-full bg-gray-300 drop-shadow-lg transform translate-x-0 transition-transform slide mx-0.5">
                                        </div>
                                    </div>
