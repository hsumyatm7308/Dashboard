    ...
    <section>
        ...
        <div>
            <div class=" modal flex justify-center items-center  ">
                ...
                <div
                    class=" bg-[linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5))] fixed left-0 top-0 z-20 modal-dialog none">
                </div>

                <div
                    class="w-[450px] h-screen bg-gray-100  transition-all duration-200 absolute z-20 -right-[100%] top-0 modal-body">
