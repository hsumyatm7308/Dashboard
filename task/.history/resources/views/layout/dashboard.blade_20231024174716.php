        ...
        <div class="" hidden>
            <div class="w-52 bg-gray-100 border rounded shadow-lg absolute right-5 md:right-12 top-20 z-20 mt-1 modal">
                <div class=" flex justify-center items-center flex-col px-1 pb-3">
                    ...
                    <div class="flex justify-center items-center self-start px-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="flex justify-center items-center self-start px-3 pb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div id="" class="flex justify-center items-center self-start px-3 pb-4 setting-btn">
