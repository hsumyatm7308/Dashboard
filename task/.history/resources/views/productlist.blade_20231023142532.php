...
<div class="w-full h-[75vh] flex justify-start items-center mt-10">
    <div class="w-[95%] h-full bg-gray-200 rounded">
        ...
        <table class="w-full border-separate border-spacing-2 border border-slate-500 mt-5">
            <tr class="">
            ...
            <tbody class="text-center">
                ...
                <tr class="">
                <td class="border border-slate-600">{{$product->id}}</td>
                <td class="border border-slate-600">{{$product->photo}}</td>
                <td>{{$product->name}}</td>
                <td>{{$product->stock}}</td>
                <td>{{$product->price}}</td>
