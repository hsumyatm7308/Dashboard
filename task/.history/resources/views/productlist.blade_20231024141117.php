...
<div class="ml-4 mt-5"> <h1 class="text-lg font-semibold">Product List</h1> <div> <p class="text-sm text-gray-500">Home
    > Product List</p>
    </div> <div class="w-full h-[75vh] flex justify-start items-center mt-10">
    <div class="w-[95%] h-full bg-gray-100 rounded"> <div
        class=" flex justify-between items-center border-b border-b-gray-300 p-4">
        <p class=" font-semibold text-gray-700">All Products</p>
        <div class="text-sm mr-5">
        <select name="" id="" class="bg-gray-00 rounded border border-blue-500 p-1 outline-none">
        ...
        <t  able class="w-full border-separate border-spacing-x-2 border-spacing-y-3 mt-2">
                <tr class="">
